    ...
    <div className="settings">
      <div className="settings__wrapper">
        <div className="settings__heading">
          <span className="settings__mainTitle">Cập Nhật Tài Khoản Của Bạn</span>
          {/* <span className="settings__btnDelete" title="Không thể khôi phục khi nhấn" onClick={handleDelete}>Xoá tài khoản</span> */}
        </div>
            ...
            <form className="settings__form" onSubmit={handleSubmit}>
              ...
              <div className="settings__profile">
                <label htmlFor="fileInput" className="settings__profilePic">
                  <img
                    src={file ? URL.createObjectURL(file) : user.profilePic ? user.profilePic : ImgDefault}
                    alt="" 
                  />
